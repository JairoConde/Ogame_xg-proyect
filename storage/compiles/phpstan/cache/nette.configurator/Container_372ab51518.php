...
// source: phar:///home/jairoconde/xg-proyect/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon
...
class Container_372ab51518 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_372ab51518 $container)
			{
	...
	public function createServiceContainer(): Container_372ab51518
	{
		return $this;
	}
