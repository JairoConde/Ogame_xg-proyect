...
class Container_bbbf1bb5af extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_bbbf1bb5af $container)
			{
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('083'),
			[],
			['analyseAndScan' => ['/home/jairoconde/xg-proyect/vendor'], 'analyse' => []]
		);
	}
	...
	public function createServiceContainer(): Container_bbbf1bb5af
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludes_analyse' => [],
			'excludePaths' => ['analyseAndScan' => ['/home/jairoconde/xg-proyect/vendor'], 'analyse' => []],
			'level' => 1,
